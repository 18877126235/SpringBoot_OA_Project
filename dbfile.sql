...
insert  into `aoa_bursement`(`bursement_id`,`all_money`,`allinvoices`,`burse_time`,`financial_advice`,`manager_advice`,`name`,`type_id`,`operation_name`,`pro_id`,`user_name`) values (1,900,1,NULL,NULL,NULL,'奥里给',25,NULL,1,2),(2,200,1,NULL,NULL,NULL,'张三',25,NULL,3,1);
...
insert  into `aoa_detailsburse`(`detailsburse_id`,`descript`,`detailmoney`,`invoices`,`produce_time`,`subject`,`bursment_id`) values (1,'请客户吃饭',900,1,'2020-04-18 00:00:00','住宿/餐饮',1),(2,'高铁计程车',200,1,'2020-04-18 00:00:00','乘车/出租',2);
...
insert  into `aoa_holiday`(`holiday_id`,`leave_days`,`type_id`,`pro_id`,`manager_advice`,`personnel_advice`) values (1,2,39,2,NULL,NULL),(2,2,37,4,NULL,NULL);
...
insert  into `aoa_process_list`(`process_id`,`apply_time`,`deeply_id`,`end_time`,`process_des`,`process_name`,`procsee_days`,`is_checked`,`start_time`,`status_id`,`type_name`,`pro_file_id`,`process_user_id`,`shenuser`) values (1,'2020-04-18 10:06:29',22,NULL,'哈哈哈哈哈','刘大庆四月份报销',NULL,0,NULL,23,'费用报销',103,36,'伊丽莎白'),(2,'2020-04-18 10:44:20',22,'2020-04-20 00:00:00','心情不好，出去散散心','刘大庆四月份请假',2,0,'2020-04-18 00:00:00',23,'请假申请',NULL,36,'伊丽莎白'),(3,'2020-04-18 11:45:25',22,NULL,'再来一单','刘大庆四月份请假2',NULL,0,NULL,23,'费用报销',NULL,36,'伊丽莎白'),(4,'2020-04-18 17:58:43',22,'2020-04-20 00:00:00','谈话人体建模女艺人今天你就让他','回老家包事情',2,0,'2020-04-18 00:00:00',23,'请假申请',104,36,'伊丽莎白');
...
insert  into `aoa_reviewed`(`reviewed_id`,`advice`,`reviewed_time`,`status_id`,`pro_id`,`user_id`,`del`) values (1,NULL,NULL,23,1,3,0),(2,NULL,NULL,23,2,3,0),(3,NULL,NULL,23,3,3,0),(4,NULL,NULL,23,4,3,0);
