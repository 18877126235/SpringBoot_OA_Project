...
insert  into `aoa_attends_list`(`attends_id`,`attends_ip`,`attends_remark`,`attends_time`,`status_id`,`type_id`,`attends_user_id`,`attend_hmtime`,`week_ofday`,`holiday_days`,`holiday_start`) values (1,'192.168.1.110',NULL,'2020-04-28 17:10:04',11,8,1,'17:10','星期二',NULL,NULL);
...
insert  into `aoa_comment_list`(`duiying_user_name`,`comment_id`,`comment`,`time`,`comment_user_id`,`reply_id`) values ('刘大庆',1,'反了？？<img src=\"http://localhost:8888/plugins/kindeditor/plugins/emoticons/images/10.gif\" border=\"0\" alt=\"\" />','2020-04-28 17:19:53',1,100);
...
insert  into `aoa_director`(`director_id`,`address`,`company_number`,`email`,`attachment_id`,`phone_number`,`pinyin`,`remark`,`sex`,`user_name`,`user_id`,`companyname`) values (19,'防城港','530299','2468282708@qq.com',100,'18877125291','zhuoke','嘻嘻','男','著科',1,'南宁学院');
...
insert  into `aoa_director_users`(`director_users_id`,`catelog_name`,`is_handle`,`director_id`,`user_id`,`share_user_id`,`sharetime`) values (79,'大学同学',0,NULL,1,NULL,'2020-03-26 16:59:16'),(80,'',0,NULL,1,NULL,'2020-03-26 17:00:05'),(85,'',1,19,36,1,'2020-03-26 18:31:45');
...
insert  into `aoa_file_path`(`path_id`,`parent_id`,`path_name`,`path_user_id`,`path_istrash`) values (100,1,'罗密欧',1,0),(101,1,'德莱文',1,0),(102,101,'重要文件',1,0);
