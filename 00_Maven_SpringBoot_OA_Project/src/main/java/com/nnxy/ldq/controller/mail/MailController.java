package com.nnxy.ldq.controller.mail;
...
import com.nnxy.ldq.model.dao.maildao.InMailDao;
import com.nnxy.ldq.model.dao.maildao.MailnumberDao;
...
import com.nnxy.ldq.model.entity.mail.Inmaillist;
import com.nnxy.ldq.model.entity.mail.Mailnumber;
						...
						while (st.hasMoreElements()) {
							if(!StringUtil.isEmpty(file.getOriginalFilename())){
								...
								mservice.pushmail(number.getMailAccount(),
										number.getPassword(),
										st.nextToken(),
										number.getMailUserName(),
										mail.getMailTitle(),
										mail.getContent(),
										attaid.getAttachmentPath(), attaid.getAttachmentName());
