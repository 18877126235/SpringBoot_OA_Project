...
public interface ReviewedDao extends PagingAndSortingRepository<Reviewed, Long>{
	...
	//根据审核人查找流程
	@Query("select new com.nnxy.ldq.model.entity.process.AubUser(pro.processId,pro.typeNmae,pro.deeply,pro.processName,pro.userId.userName,pro.applyTime,rev.statusId) "
