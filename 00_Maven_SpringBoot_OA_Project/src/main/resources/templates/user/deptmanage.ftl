					...
					<table class="table table-hover table-striped">
						...
						<#list depts as dept>
							<tr>
								...
								<td>
									<a href="deptedit?dept=${dept.deptId}" class="btn-default xiugai">
									<span class="glyphicon glyphicon-edit"></span> 修改</a> 
									<a href="readdept?deptid=${dept.deptId}" class="btn-default xiugai">
										<span class="glyphicon glyphicon-search"></span> 部门详情
									</a>
									<a href="readdept?deptid=${dept.deptId}" class="btn-default shanchu"> 删除</a></td>
							</tr>
						</#list>
					</table>
				</div>
