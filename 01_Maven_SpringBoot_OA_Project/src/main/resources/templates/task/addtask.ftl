	...
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<div class="box-footer">
				<input class="btn btn-primary" id="save"  style="display: none" type="submit" value="保存" />
			...
			<div class="box-footer">
				<input class="btn btn-primary" id="baocunzhixing" type="button" value="保存" />
				<input class="btn btn-default" id="cancel" type="button" value="取消"  onclick="quxiao()" />
			</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		//点击确定  
		$("#baocunzhixing").click(function(){
			
			//先判断有没有未填写的内容
			//提示框可能在提交之前是block状态，所以在这之前要设置成none
			$('.alert-danger').css('display', 'none');
			var isRight = 1;
			$('.form-control').each(function(index) { //循环遍历
