		...
		<div class="bgc-w box box-solid " style="border-top: 3px solid blue;">
			...
			<#-- 以下执行修改头像操作 *******************************************************-->
				<span class="imgs center-block">
					...
					<form id="biaodan" action="fileUpload2" method="post" enctype="multipart/form-data">
						<#if user.imgPath?? && user.imgPath!=''  >
						<img id="img3" style="width: 110px;height: 110px;"
						...
						<input type="file"  name="upload"  id="file" class="filepath" onchange="changepic(this)" accept="image/jpg,image/jpeg,image/png,image/PNG" >	
				...
				<h3 class="profile-username text-center">
					...
					<span id="ctl00_cphMain_lblFullName">
						<a id="chooce" href="#">更换头像</a>
						<a id="upshangchuan" href="#">确定上传</a>
					</span>
				...
				<h3 class="profile-username text-center">
					<span id="ctl00_cphMain_lblFullName"><h4>${user.userName}</h4></span>
				</h3>
				<p style="color: seagreen;" class="text-muted text-center">
...
<script>
		...
		function changepic() {
			 ...
			 reads.onload = function(e) {  //配置显示路径
			 	...
			 	document.getElementById('img3').src = this.result;
			 	 ...
			 	 $('#upshangchuan').css('display','block');
			 };
	...
	$(function(){
		...
		<#-- 点击确定上传头像 -->
		$("#upshangchuan").click(function(){
		
			$("#biaodan").submit();
		
			<#-- 隐藏自己 -->
			 $('#upshangchuan').css('display','none');
