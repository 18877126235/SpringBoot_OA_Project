						...
						<div class="box-body">
							<div class="row">
								<div class="col-md-12 form-group">
									<h4>部门名称：${dept.deptName} </h4>
									<#if (deptuser?? & deptuser?size gt 0) || deptmanage??>
										<a class="label sheding" href="javascript:void(0);">删除该部门</a>
									<#else>
										<a class="label shanchu" href="deletdept?deletedeptid=${dept.deptId}">删除</a>
									</#if>
								</div>
								<div class="col-md-12 form-group">
									<h4>部门经理：${(deptmanage.realName)!'暂无'} </h4>
	
									<#if (deptuser?? & deptuser?size gt 0) || deptmanage??>
										<a class="changemanage label xiugai">更换部门经理</a>
									<#else>
							...
							<#if isread??>
								...
								<table class="table table-hover table-striped">
									...
									<#list deptuser as user>
										<tr>
											<td><img src="/image/${(user.imgPath)!'/timg.jpg'}" class="img-circle"
